...
func TestNewTree(t *testing.T) {
	...
	want.children = []*Tree[p]{
		{parent: want, heapIndex: 0, E: p(1)},
		{parent: want, heapIndex: 1, E: p(2)},
		{parent: want, heapIndex: 2, E: p(4)},
		{parent: want, heapIndex: 3, E: p(3)},
		{parent: want, heapIndex: 4, E: p(5)},
		{parent: want, heapIndex: 5, E: p(6)},
	}
	want.children[5].children = []*Tree[p]{
		{parent: want.children[5], heapIndex: 0, E: p(7)},
	}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
...
func TestNewChildNoChildren(t *testing.T) {
	...
	wantChild := &Tree[p]{parent: n, E: p(1)}
...
func TestNewChild(t *testing.T) {
	...
	want.children = []*Tree[p]{
		{parent: want, heapIndex: 0, E: p(1)},
		{parent: want, heapIndex: 1, E: p(2)},
		{parent: want, heapIndex: 2, E: p(5)},
		{parent: want, heapIndex: 3, E: p(4)},
		{parent: want, heapIndex: 4, E: p(3)},
		{parent: want, heapIndex: 5, E: p(6)},
	}
	want.children[5].children = []*Tree[p]{
		{parent: want.children[5], heapIndex: 0, E: p(7)},
...
func TestReplaceElem(t *testing.T) {
	...
	want.children = []*Tree[p]{
		{parent: want, heapIndex: 0, E: p(0)},
		{parent: want, heapIndex: 1, E: p(2)},
		{parent: want, heapIndex: 2, E: p(3)},
		{parent: want, heapIndex: 3, E: p(4)},
		{parent: want, heapIndex: 4, E: p(6)},
	}
...
func TestRemoveNoParent(t *testing.T) {
	got := NewTree(p(0))
	got.Remove()
	want := &Tree[p]{parent: nil, heapIndex: 0, E: p(0)}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
...
func TestRemove(t *testing.T) {
	...
	got := n.children[0]
	n.children[0].Remove()
	want := &Tree[p]{parent: nil, heapIndex: 0, E: p(1)}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
	...
	got = n.children[3]
	n.children[3].Remove()
	want = &Tree[p]{parent: nil, heapIndex: 0, E: p(5)}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
	...
	want.children = []*Tree[p]{
		{parent: want, heapIndex: 0, E: p(2)},
		{parent: want, heapIndex: 1, E: p(4)},
		{parent: want, heapIndex: 2, E: p(3)},
	}
	if diff := cmp.Diff(want, n, cmp.AllowUnexported(Tree[p]{})); diff != "" {
...
func TestPop(t *testing.T) {
	...
	// Pop p(2).
	got = n.Pop()
	want = &Tree[p]{parent: nil, heapIndex: 0, E: p(2)}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
		t.Errorf("TestPop(): got Pop()#1 diff:\n%s", diff)
	}
	// Pop p(3).
	got = n.Pop()
	want = &Tree[p]{parent: nil, heapIndex: 0, E: p(3)}
	if diff := cmp.Diff(want, got, cmp.AllowUnexported(Tree[p]{})); diff != "" {
	...
	want.children = []*Tree[p]{
		{parent: want, heapIndex: 0, E: p(4)},
		{parent: want, heapIndex: 1, E: p(5)},
	}
	if diff := cmp.Diff(want, n, cmp.AllowUnexported(Tree[p]{})); diff != "" {
		t.Errorf("TestRemove(): got result diff:\n%s", diff)
	}
